---
layout: post
title: "New in High Baseline Support: contain-intrinsic-size"
...
- ``css.properties.contain-intrinsic-block-size.none`` [[mdn]](https://developer.mozilla.org/en-US/search?q=css.properties.contain-intrinsic-block-size.none)
- ``css.properties.contain-intrinsic-height.none`` [[mdn]](https://developer.mozilla.org/en-US/search?q=css.properties.contain-intrinsic-height.none)
- ``css.properties.contain-intrinsic-inline-size.none`` [[mdn]](https://developer.mozilla.org/en-US/search?q=css.properties.contain-intrinsic-inline-size.none)
- ``css.properties.contain-intrinsic-size.none`` [[mdn]](https://developer.mozilla.org/en-US/search?q=css.properties.contain-intrinsic-size.none)
- ``css.properties.contain-intrinsic-width.none`` [[mdn]](https://developer.mozilla.org/en-US/search?q=css.properties.contain-intrinsic-width.none)
