...
[caniuse](https://caniuse.com/?search=rect-xywh) · [mdn](https://developer.mozilla.org/en-US/search?q=rect() and xywh()) · [spec](['https://drafts.csswg.org/css-shapes-1/#funcdef-basic-shape-xywh', 'https://drafts.csswg.org/css-shapes-1/#funcdef-basic-shape-rect'])
