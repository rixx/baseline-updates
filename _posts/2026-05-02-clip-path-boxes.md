---
layout: post
title: "New in High Baseline Support: Clip path boxes"
tags: baseline-high clipping-shapes-masking
---

[caniuse](https://caniuse.com/?search=clip-path-boxes) · [mdn](https://developer.mozilla.org/en-US/search?q=Clip path boxes) · [spec](https://drafts.csswg.org/css-masking-1/#the-clip-path)
