---
layout: post
title: "New in High Baseline Support: Lab and LCH"
...
- ``css.types.color.lab.mixed_type_parameters`` [[mdn]](https://developer.mozilla.org/en-US/search?q=css.types.color.lab.mixed_type_parameters)
- ``css.types.color.lch.mixed_type_parameters`` [[mdn]](https://developer.mozilla.org/en-US/search?q=css.types.color.lch.mixed_type_parameters)
