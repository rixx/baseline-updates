---
layout: post
title: "New in High Baseline Support: Storage manager"
...
- ``api.Permissions.permission_persistent-storage`` [[mdn]](https://developer.mozilla.org/en-US/search?q=api.Permissions.permission_persistent-storage)
